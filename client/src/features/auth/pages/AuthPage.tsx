...
import {
  ...
  FormLabel,
  FormMessage,
} from "@/components/inputs/form"; // Updated path
import { Input } from "@/components/inputs/InputField"; // Updated path
import { Loader2 } from "lucide-react";
import gymPixelImage from "@/assets/gym-pixel.png"; // Assuming @/assets is a valid alias or path works from src
...
export default function AuthPage() {
  ...
  const [, navigate] = useLocation(); // location variable removed as it's not used
